"""Extra official analog Sport SKUs. No Digital/ARC electronics."""
...
EXTRA_CARDS: list[dict[str, Any]] = [
    {"sku": "C8201", "name": "R1 hairpin 90 (C8201)", "family": "r1", "group": "Radius 1", "hand": None, "hint": "Letter J. Same piece both ways. Pack is two pieces."},
    {"sku": "C8202", "name": "R1 inner 45 (C8202)", "family": "r1", "group": "Radius 1", "hand": None, "hint": "Letter K. Rotate for left or right."},
    {"sku": "C8234", "name": "R2 22.5 (C8234)", "family": "r2", "group": "Radius 2", "hand": None, "hint": "Letter U. One moulding."},
