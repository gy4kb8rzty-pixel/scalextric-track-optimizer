...
LEVELS = {
    ...
    AccuracyLevel.DETAILED: _p(AccuracyLevel.DETAILED, "C", "Detailed", "Close to Full: same parts, slightly shorter lap and a modest shop cap.", "hybrid", False, False, 64, 14, 28000.0, 13.0, 26.0, 24.0, 380.0, 140.0, 200.0, 550, False, True, True, "full", scale_frac=0.86, min_target_mm=21000.0, max_target_mm=32000.0),
