...
LEVELS = {
    ...
    AccuracyLevel.LEAN_BUDGET: _p(AccuracyLevel.LEAN_BUDGET, "A", "Lean Budget", "Manual only. Larger simple red outline so Sport corners fit.", "manual", False, False, 56, 8, 13000.0, 36.0, 32.0, 28.0, 900.0, 280.0, 400.0, 140, True, False, False, "lean", scale_frac=0.48, min_target_mm=11000.0, max_target_mm=16000.0),
    AccuracyLevel.BUDGET: _p(AccuracyLevel.BUDGET, "B", "Budget", "Larger detailed red guide. Full catalogue. Follow the whole lap.", "sequential", False, False, 160, 24, 28000.0, 24.0, 26.0, 24.0, 380.0, 220.0, 200.0, 400, True, False, False, "full", scale_frac=0.95, min_target_mm=24000.0, max_target_mm=34000.0),
