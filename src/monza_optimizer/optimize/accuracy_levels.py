...
LEVELS = {
    ...
    AccuracyLevel.DETAILED: _p(AccuracyLevel.DETAILED, "C", "Detailed", "Larger official red line scale profile ~34-48 meters so hairpins fit. Full catalogue. Shop cap 180 pieces / 28 SKUs. More accurate fit than B.", "sequential", False, False, 180, 28, 36000.0, 13.0, 26.0, 24.0, 380.0, 240.0, 200.0, 550, False, False, True, "full", scale_frac=1.15, min_target_mm=34000.0, max_target_mm=48000.0),
