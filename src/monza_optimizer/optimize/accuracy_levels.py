...
LEVELS = {
    ...
    AccuracyLevel.LEAN_BUDGET: _p(AccuracyLevel.LEAN_BUDGET, "A", "Lean Budget", "Silhouette that stays a single ribbon. Buys the shorts and radii that stop crossings.", "sequential", False, False, 18, 6, 12000.0, 28.0, 50.0, 50.0, 1400.0, 400.0, 700.0, 80, True, False, False, "standard", scale_frac=0.40, min_target_mm=9000.0, max_target_mm=15000.0),
    AccuracyLevel.BUDGET: _p(AccuracyLevel.BUDGET, "B", "Budget", "Follow the red line without knots. Shop list can grow to keep one clean lap.", "sequential", False, False, 36, 8, 18000.0, 16.0, 32.0, 32.0, 420.0, 180.0, 280.0, 200, True, True, False, "standard", scale_frac=0.60, min_target_mm=15000.0, max_target_mm=22000.0),
    AccuracyLevel.DETAILED: _p(AccuracyLevel.DETAILED, "C", "Detailed", "Near-full layout. Hairpins and shorts allowed; only a light shop cap vs Full.", "hybrid", False, False, 80, 16, 30000.0, 12.0, 24.0, 24.0, 380.0, 130.0, 200.0, 700, False, True, True, "full", scale_frac=0.92, min_target_mm=22000.0, max_target_mm=34000.0),
