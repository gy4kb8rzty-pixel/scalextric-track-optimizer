...
LEVELS = {
    ...
    AccuracyLevel.DETAILED: _p(AccuracyLevel.DETAILED, "C", "Detailed", "Close to Full: same parts, slightly shorter lap and a modest shop cap.", "sequential", False, False, 64, 14, 36000.0, 13.0, 26.0, 24.0, 380.0, 240.0, 200.0, 550, False, False, True, "full", scale_frac=1.15, min_target_mm=34000.0, max_target_mm=48000.0),
