...
LEVELS = {
    ...
    AccuracyLevel.LEAN_BUDGET: _p(AccuracyLevel.LEAN_BUDGET, "A", "Lean Budget", "Follow the red line with as few pieces as possible.", "sequential", False, False, 48, 8, 7000.0, 40.0, 40.0, 36.0, 520.0, 140.0, 240.0, 120, True, False, False, "lean", scale_frac=0.22, min_target_mm=5500.0, max_target_mm=8000.0),
