...
LEVELS = {
    ...
    AccuracyLevel.BUDGET: _p(AccuracyLevel.BUDGET, "B", "Budget", "Detailed red line ~24-34 m. Full catalogue. Shop cap 160 pieces / 24 SKUs. Stays on the line; no infield shortcut.", "sequential", False, False, 160, 24, 28000.0, 24.0, 26.0, 24.0, 380.0, 220.0, 200.0, 400, True, False, False, "full", scale_frac=0.95, min_target_mm=24000.0, max_target_mm=34000.0),
