...
LEVELS = {
    ...
    AccuracyLevel.BUDGET: _p(AccuracyLevel.BUDGET, "B", "Budget", "Follow the detailed red centreline with the full catalogue. Stay on the line; do not cut the infield.", "sequential", False, False, 120, 20, 18000.0, 28.0, 28.0, 26.0, 380.0, 150.0, 160.0, 320, True, False, False, "full", scale_frac=0.62, min_target_mm=12000.0, max_target_mm=22000.0),
