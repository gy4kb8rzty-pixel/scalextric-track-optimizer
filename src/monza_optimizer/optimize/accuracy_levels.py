...
LEVELS = {
    ...
    AccuracyLevel.BUDGET: _p(AccuracyLevel.BUDGET, "B", "Budget", "Simplified red guide. Full official catalogue. Follow the main straight and big corners.", "sequential", False, False, 56, 10, 14000.0, 36.0, 36.0, 32.0, 420.0, 240.0, 280.0, 200, False, False, False, "full", scale_frac=0.42, min_target_mm=9000.0, max_target_mm=16000.0),
