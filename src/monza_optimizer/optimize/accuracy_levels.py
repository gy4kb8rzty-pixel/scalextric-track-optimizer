...
LEVELS = {
    ...
    AccuracyLevel.BUDGET: _p(AccuracyLevel.BUDGET, "B", "Budget", "Detailed official red line profile ~24-34 meters of track. Full catalogue. Shop cap 160 / 24 SKUs.", "sequential", False, False, 160, 24, 28000.0, 38.0, 26.0, 24.0, 380.0, 220.0, 200.0, 400, True, False, False, "full", scale_frac=0.95, min_target_mm=24000.0, max_target_mm=34000.0),
    AccuracyLevel.DETAILED: _p(AccuracyLevel.DETAILED, "C", "Detailed", "Larger official red line scale profile ~34-48 meters so hairpins fit. Full catalogue. Shop cap 180 pieces / 28 SKUs. Tighter fit than B.", "sequential", False, False, 180, 28, 36000.0, 13.0, 26.0, 24.0, 380.0, 240.0, 200.0, 550, False, False, True, "full", scale_frac=1.15, min_target_mm=34000.0, max_target_mm=48000.0),
    AccuracyLevel.FULL_ACCURACY: _p(AccuracyLevel.FULL_ACCURACY, "D", "Full Accuracy", "Largest everyday official scale profile ~48-64 meters of track. Unlimited catalogue and buy list. Tightest follow of the red centreline. Output includes flyover feature.", "sequential", True, False, 10000, 10000, 50000.0, 12.0, 22.0, 22.0, 360.0, 280.0, 180.0, 900, False, False, True, "full", scale_frac=1.5, min_target_mm=48000.0, max_target_mm=64000.0),
