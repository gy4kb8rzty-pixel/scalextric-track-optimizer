...
LEAN_CANDIDATES = ["C8207", "C8200", "C8236", "C8206L", "C8206R", "C8010L", "C8010R"]
...
LEVELS = {
    ...
    AccuracyLevel.LEAN_BUDGET: _p(AccuracyLevel.LEAN_BUDGET, "A", "Lean Budget", "Tiny red guide. One simple silhouette, no long chords.", "sequential", False, False, 32, 7, 7000.0, 48.0, 48.0, 42.0, 520.0, 200.0, 320.0, 100, False, False, False, "lean", scale_frac=0.22, min_target_mm=5500.0, max_target_mm=8000.0),
