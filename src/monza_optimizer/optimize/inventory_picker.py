...
Each card is an official Sport SKU the optimizer already understands,
plus a top-view graphic so a phone user can match the piece in the box.
Graphics prefer the repo BMP silhouettes (same files as the Classic/Sport
reference set at the repo root). SVG fallbacks stay on-device when BMPs
are not served.
"""
...
# Underside letter moulded into Sport track (Action Slot / Scalextric guides).
LETTER_UNDER = {
    "C8200": "F",
    "C8204": "N",
    "C8204L": "N",
...
# Repo-root BMP silhouettes already checked into monza-optimizer-v1.
THUMB_BMP = {
    "C8205": "c8205.bmp",
    "C8207": "c8207p.bmp",
    "C8200": "c8200p.bmp",
...
# Tick cards shown in the wrapper. Order is the phone grid order.
CARDS: list[dict[str, Any]] = [
    {
        "sku": "C8205",
        "name": "Standard straight 350 mm",
        "family": "straight",
        "group": "Straights",
        "hand": None,
        "hint": "Long black straight. Letter B underneath.",
    },
    {
        "sku": "C8207",
        "name": "Half straight 175 mm",
        "family": "straight",
        "group": "Straights",
        "hand": None,
        "hint": "Half the standard straight. Letter D underneath.",
    },
    {
        "sku": "C8200",
        "name": "Quarter straight 87 mm",
        "family": "straight",
        "group": "Straights",
        "hand": None,
        "hint": "Short filler. Letter F underneath.",
    },
    {
        "sku": "C8236",
        "name": "Short straight 78 mm",
        "family": "straight",
        "group": "Straights",
        "hand": None,
        "hint": "Tiny closer. Letter T underneath.",
    },
    {
        "sku": "C8206L",
        "name": "R2 curve 45° left",
        "family": "r2",
        "group": "Radius 2",
        "hand": "L",
        "hint": "Standard starter bend, turns left. Letter C underneath.",
    },
    {
        "sku": "C8206R",
        "name": "R2 curve 45° right",
        "family": "r2",
        "group": "Radius 2",
        "hand": "R",
        "hint": "Standard starter bend, turns right. Letter C underneath.",
    },
    {
        "sku": "C8234L",
        "name": "R2 curve 22.5° / 11.25° left",
        "family": "r2",
        "group": "Radius 2",
        "hand": "L",
        "hint": "Shallower R2. Letter U underneath.",
    },
    {
        "sku": "C8234R",
        "name": "R2 curve 22.5° / 11.25° right",
        "family": "r2",
        "group": "Radius 2",
        "hand": "R",
        "hint": "Shallower R2. Letter U underneath.",
    ...
    {
        "sku": "C8204L",
        "name": "R3 curve 22.5° left",
        "family": "r3",
        "group": "Radius 3",
        "hand": "L",
        "hint": "Wider sweep. Letter N underneath.",
    },
    {
        "sku": "C8204R",
        "name": "R3 curve 22.5° right",
        "family": "r3",
        "group": "Radius 3",
        "hand": "R",
        "hint": "Wider sweep. Letter N underneath.",
    ...
    {
        "sku": "C8235L",
        "name": "R4 curve 22.5° left",
        "family": "r4",
        "group": "Radius 4",
        "hand": "L",
        "hint": "Outer sweep. Letter S underneath.",
    },
    {
        "sku": "C8235R",
        "name": "R4 curve 22.5° right",
        "family": "r4",
        "group": "Radius 4",
        "hand": "R",
        "hint": "Outer sweep. Letter S underneath.",
    ...
    {
        "sku": "C156L",
        "name": "R1 hairpin 90° left",
        "family": "r1",
        "group": "Radius 1",
        "hand": "L",
        "hint": "Tight inner hairpin.",
    },
    {
        "sku": "C156R",
        "name": "R1 hairpin 90° right",
        "family": "r1",
        "group": "Radius 1",
        "hand": "R",
        "hint": "Tight inner hairpin.",
    ...
    {
        "sku": "C187L",
        "name": "Banked curve 45° left",
        "family": "banked",
        "group": "Specials",
        "hand": "L",
        "hint": "Raised outer edge.",
    },
    {
        "sku": "C187R",
        "name": "Banked curve 45° right",
        "family": "banked",
        "group": "Specials",
        "hand": "R",
        "hint": "Raised outer edge.",
    ...
    {
        "sku": "C8010L",
        "name": "Chicane curve 22.5° left",
        "family": "chicane",
        "group": "Specials",
        "hand": "L",
        "hint": "Offset lane chicane bend.",
    },
    {
        "sku": "C8010R",
        "name": "Chicane curve 22.5° right",
        "family": "chicane",
        "group": "Specials",
        "hand": "R",
        "hint": "Offset lane chicane bend.",
...
def _svg_icon(family: str, hand: str | None) -> str:
    ...
    if family == "straight":
        ...
        # Simple arc block; handedness flips the sweep.
        body = (
...
def ticks_to_inventory(ticks: list[dict[str, Any]] | dict[str, int] | None) -> dict[str, int]:
    """Lovable checkbox grid → optimizer inventory dict."""
    if ticks is None:
        return {}
...
def picker_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "presets": [
            {
                ...
                "label": "Empty box",
                "inventory": {},
                "note": "Bare Bones shopping list from a zero start.",
            },
            {
                "id": "flying_start",
        ...
        "optimize_hint": {
            ...
            "example": {"track_id": "monza", "accuracy_level": "B", "inventory": {"C8205": 4}},
        },
    }
